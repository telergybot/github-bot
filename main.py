...
bot = telebot.TeleBot('265444835:AAFquiXHdeB_A4CmHiBSLFTmYUYVw3fnKPE') # makan token shoma

@bot.message_handler(commands=['start', 'help'])
def m(m):
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton('Inline Mode', switch_inline_query='taylor-team'))
    bot.send_message(m.chat.id, 'Hi Welcome Github search bot\ncommands : \n/git [username]\n\ncreated By Amirreza Ebrahimi \ndeveloper : @amrrezaebrahimi', reply_markup=markup)
